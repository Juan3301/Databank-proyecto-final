...
class Card:
    def __init__(self, account: "BankAccount", pin: str, credit_type: bool, debit_type: bool, card_number: str | None = None, cvv: str | None = None, expiration_date: datetime | None = None, is_blocked: bool = False):
        ...
        self.card_number = (
            card_number if card_number is not None
            else str(uuid.uuid4().int)[:16]
            )
        
        self.cvv = (
            cvv if cvv is not None
            else str(uuid.uuid4().int)[:3]
            )
        ...
        self.expiration_date = (
            expiration_date if expiration_date is not None
    ...
    def from_dict(cls, data, accounts):
        ...
        card = cls(
            account=account,
            pin=data["pin"],
            credit_type=data["is_credit_card"],
            debit_type=data["is_debit_card"],
